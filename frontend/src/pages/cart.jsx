...
'>
                                    ...
                                    <input type="number" min={1} defaultValue={item.
                                        quantity} className=' md:max-w-20 max-w-15 md:px-2 md:py-2 py-[5px] px-[10px] text-[white] text-[18px] font-semibold bg-[#518080b4] absolute md:top-[40%] top-[46%] left-[75%] md:left-[50%] border-[1px] border-[#9ff9f9] rounded-md '
